...
**客户端调用**：
```python
from kbquant.schemas.information import DedupCheckRequest
...
**客户端调用**：
```python
from kbquant.schemas.information import InformationMergeRequest
...
**客户端调用**：
```python
from kbquant.schemas.entity import EntityCreate
...
**客户端调用**：
```python
from kbquant.schemas.entity import EntityRelationshipCreate
...
世界节点是知识图谱的核心组织单元，代表一个投资标的或分析主题（如"贵州茅台"、"白酒板块"、"货币政策"），支持多对多关联图结构。
...
**客户端调用**：
```python
from kbquant.schemas.node import WorldNodeCreate
...
**客户端调用**：
```python
from kbquant.schemas.node import NodeAttachmentCreate
...
**客户端调用**：
```python
from kbquant.schemas.node import NodeStateCreate
...
**客户端调用**：
```python
from kbquant.schemas.node import NodeCompressionRequest
...
**客户端调用**：
```python
from kbquant.schemas.trading import TradingOperationCreate
...
**客户端调用**：
```python
from kbquant.schemas.trading import TradingOperationUpdate
...
**客户端调用**：
```python
from kbquant.schemas.search import HybridSearchRequest
...
**客户端调用**：
```python
from kbquant.schemas.search import TaskSearchRequest
...
**客户端调用**：
```python
from kbquant.schemas.search import MultiGranularityRequest
...
**客户端调用**：
```python
from kbquant.schemas.search import SimilarCaseRequest
...
**客户端调用**：
```python
from kbquant.schemas.pipeline import ReprioritizeRequest
...
**客户端调用**：
```python
from kbquant.schemas.validity import TimeValidityCreate
...
**客户端调用**：
```python
from kbquant.schemas.validity import ValidityExpireRequest
...
**客户端调用**：
```python
from kbquant.schemas.validity import ValidityExtendRequest
...
**客户端调用**：
```python
from kbquant.schemas.conflict import ConflictDetectRequest
...
**客户端调用**：
```python
from kbquant.schemas.conflict import ConflictResolveRequest
...
**客户端调用**：
```python
from kbquant.schemas.ranking import RankingComputeRequest
